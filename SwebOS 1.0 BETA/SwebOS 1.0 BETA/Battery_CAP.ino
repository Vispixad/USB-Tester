...
void drawTextBattery() {
  ...
  tft.setTextColor(tft.color565(3, 161, 252), tft.color565(0, 8, 13));
  String cell = (cellIndex + 1 < 9) ? "0" + String(cellIndex + 1) : String(cellIndex + 1);
  tft.drawString(cell, 62, 36);

  tft.setTextColor(tft.color565(232, 190, 2), tft.color565(23, 19, 0));
...
void drawBattery() {
  if (!updateTimeBat) {
    ...
    if (currentMillised - previousMillised >= intervaled) {
      ...
      TimeBatSprite.loadFont(PTSans_Bold18);
      char buffer[20];
    ...
    ampHrsSprite.loadFont(PTSans_Bold18);
    ...
    wattHrsSprite.loadFont(PTSans_Bold18);
    ...
    dispResSprite.loadFont(PTSans_Bold34);
    ...
    dispResSprite.loadFont(PTSans_Bold18);
    ...
    if (digitalRead(BUTTON_UP) == LOW) {
      if (!batup || !cellbatup || !voltbatup || !effbatup) {
        ...
        if (!cellbatup) {
          ...
          if (!file) {
            ...
            while (file.available()) {
             /*/String line = file.readLine();*/
              tft.loadFont(PTSans_Bold18);
              tft.setTextColor(tft.color565(210, 210, 210), tft.color565(80, 80, 80));
              tft.setCursor(84, y);
              /*tft.print(line);
              Serial.println(line);*/
              y += 23;
          ...
          tft.setCursor(63, 50);
          tft.setTextColor(tft.color565(3, 161, 252), tft.color565(0, 8, 13));
          String cell = (cellIndex + 1 < 10) ? "0" + String(cellIndex + 1) : String(cellIndex + 1);
          tft.drawString(cell, 62, 36);
        }
        if (!voltbatup) {
