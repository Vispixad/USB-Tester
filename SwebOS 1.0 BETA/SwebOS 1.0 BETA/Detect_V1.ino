...
void drawTextQC() {
  ...
  tft.setTextColor(tft.color565(2, 91, 232), tft.color565(0, 51, 133));
  tft.drawString("Testing", 255, 5);

  tft.loadFont(PTSans_Bold16);
  tft.setTextColor(tft.color565(50, 50, 50), tft.color565(20, 20, 20));
  tft.drawString("QC 2.0->", 8, 36);
...
void workQC() {
  ...
  tft.setTextColor(tft.color565(0, 222, 89), tft.color565(0, 222, 89));
  if (voltageReadFlag) {
    tft.loadFont(PTSans_Regular18);
    tft.print("Finish");
  } else {
