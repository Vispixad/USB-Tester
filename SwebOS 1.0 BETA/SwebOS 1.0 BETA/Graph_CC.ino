...
void drawTextGCC() {
  ...
  tft.setTextColor(tft.color565(245, 4, 0), tft.color565(0, 0, 0));
...
void drawNoCC1() {
  tft.setRotation(3);
  tft.loadFont(PTSans_Bold18);
  tft.setTextColor(tft.color565(125, 125, 125), tft.color565(0, 0, 0));
  tft.drawString("+5.00V", 12, 4);
  tft.drawString("10.00A", 256, 4);
  tft.drawString("CC1", 116, 4);
  tft.drawString("/", 146, 2);
...
void drawNoCC2() {
  ...
  tft.setRotation(3);
  tft.setTextColor(tft.color565(255, 0, 60), tft.color565(122, 0, 29));
