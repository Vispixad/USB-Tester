...
//--------------ФЛАГИ ДЛЯ МЕНЮ ТРИГГЕРОВ QC2.0 - QC3.0-----------------
bool QC2down = false;
bool stopedQC2 = false;
bool QC3down = false;
bool stopedQC3 = false;
//---------------------------------------------------------------------
...
void setup() {
  ...
  voltageSprite.createSprite(225, 40);
  currentSprite.createSprite(225, 40);
  wattSprite.createSprite(225, 40);
...
void drawSetDeviseInfo() {
  if (!updatedevinfo) {
    ...
    TempSettSprite.setTextColor(tft.color565(255, 255, 255));
    TempSettSprite.setFreeFont(&PTSans_Regular9pt7b);
    ...
    TimeSettSprite.setTextColor(tft.color565(255, 255, 255));
    TimeSettSprite.setFreeFont(&PTSans_Regular9pt7b);
    char buffer[20];
